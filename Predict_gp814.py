...
model.to(device)
path = 'model/nezha_train_model-8152.bin'
print('使用最牛模型：', path)
...
with open('./datasets/preliminary_contest_datasets/preliminary_test_a/sample_per_line_preliminary_A.txt', 'r',
          encoding='utf-8') as f:
    lines = f.readlines()
...
with open('outputs/predict_result.txt', 'w', encoding='utf-8') as f:
