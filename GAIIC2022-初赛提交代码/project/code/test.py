...
LR = 2e-5
early_stop_epochs = 2
model_path = './data/pretrain_model/my_nezha_cn_base/'
...
def main():
    ...
    parser.add_argument('--test_data_path', type=str,
                        default=f'./data/contest_data/preliminary_test_b/sample_per_line_preliminary_B.txt')
    ...
    model.to(device)
    path = './data/best_model/best_model.bin'
    print('使用最牛模型：', path)
    ...
    with open(args.test_data_path, 'r',
              encoding='utf-8') as f:
        lines = f.readlines()
    ...
    with open('./data/submission/results.txt', 'w', encoding='utf-8') as f:
