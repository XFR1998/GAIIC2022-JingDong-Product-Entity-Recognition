...
class NeZhaConfig(PretrainedConfig):
    r"""
        ...
        It is used to instantiate an ALBERT save_model according to the specified arguments, defining the save_model
        architecture. Instantiating a configuration with the defaults will yield a similar configuration to that of
        the ALBERT `xxlarge <https://huggingface.co/albert-xxlarge-v2>`__ architecture.
        Configuration objects inherit from  :class:`~transformers.PretrainedConfig` and can be used
        to control the save_model outputs. Read the documentation from  :class:`~transformers.PretrainedConfig`
        for more information.
        Args:
            vocab_size (:obj:`int`, optional, defaults to 30000):
                Vocabulary size of the ALBERT save_model. Defines the different tokens that
            ...
            max_position_embeddings (:obj:`int`, optional, defaults to 512):
                The maximum sequence length that this save_model might ever be used with. Typically set this to something
        ...
        Example::
            ...
            # Initializing a save_model from the ALBERT-base style configuration
            save_model = AlbertModel(albert_xxlarge_configuration)
            # Accessing the save_model configuration
            configuration = save_model.config
        Attributes:
...
class NeZhaModel(NeZhaPreTrainedModel):
    ...
    def _prune_heads(self, heads_to_prune):
        """ Prunes heads of the save_model.
    ...
    Return:
        ...
        last_hidden_state (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, sequence_length, hidden_size)`):
            Sequence of hidden-states at the output of the last layer of the save_model.
    ...
    Examples::
        ...
        save_model = BertModel.from_pretrained('bert-base-uncased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
        outputs = save_model(input_ids)
...
class NeZhaForMaskedLM(NeZhaPreTrainedModel):
    ...
    Returns:
        ...
        Examples::
            ...
            import torch
            tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
            save_model = BertForMaskedLM.from_pretrained('bert-base-uncased')
            input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
            outputs = save_model(input_ids, masked_lm_labels=input_ids)
    ...
    def prepare_inputs_for_generation(self, input_ids, attention_mask=None, **model_kwargs):
        ...
        # if save_model is does not use a causal mask then add a dummy token
...
class NeZhaForSequenceClassification(NeZhaPreTrainedModel):
    ...
    Examples::
        ...
        import torch
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        save_model = BertForSequenceClassification.from_pretrained('bert-base-uncased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
        labels = torch.tensor([1]).unsqueeze(0)  # Batch size 1
        outputs = save_model(input_ids, labels=labels)
...
class NeZhaForMultipleChoice(NeZhaPreTrainedModel):
    ...
    Examples::
        ...
        import torch
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        save_model = BertForMultipleChoice.from_pretrained('bert-base-uncased')
...
class NeZhaForTokenClassification(NeZhaPreTrainedModel):
    ...
    Examples::
        ...
        import torch
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        save_model = BertForTokenClassification.from_pretrained('bert-base-uncased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class NeZhaForQuestionAnswering(NeZhaPreTrainedModel):
    ...
    Examples::
        ...
        import torch
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        save_model = BertForQuestionAnswering.from_pretrained('bert-large-uncased-whole-word-masking-finetuned-squad')
        question, text = "Who was Jim Henson?", "Jim Henson was a nice puppet"
        encoding = tokenizer.encode_plus(question, text)
        input_ids, token_type_ids = encoding["input_ids"], encoding["token_type_ids"]
        start_scores, end_scores = save_model(torch.tensor([input_ids]), token_type_ids=torch.tensor([token_type_ids]))
