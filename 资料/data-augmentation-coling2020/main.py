...
if __name__ == "__main__":
    ...
    corpus = ConllCorpus(args.task_name, './data/my_train.txt', args.dev_filepath, args.test_filepath)
    ...
    print(category2mentions)
    import pickle
    with open('./category2mentions.pkl','wb') as f:
        pickle.dump(category2mentions,f)
